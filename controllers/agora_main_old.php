...
class SPODAGORA_CTRL_AgoraMainOld extends OW_ActionController
{
    private $field;
    ...
    public function index()
    {
        ...
        OW::getDocument()->addScript(OW::getPluginManager()->getPlugin('spodagora')->getStaticJsUrl() . 'agora_old.js', 'text/javascript');
    ...
    private function setColor($a, $max)
    {
        ...
        foreach($a as $item)
        {
            $step = floor(((100*$item->views)/$max)/10);
    ...
    private function getColor($step)
    {
        ...
        $color = array('E3F2FD', 'BBDEFB', '90CAF9', '64B5F6', '42A5F5', '2196F3', '1E88E5', '1976D2', '1565C0', '0D47A1');
